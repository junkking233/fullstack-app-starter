...
1. 设计来源：PRD、Lovart Prompt、Lovart 备份稿、Stitch screen/HTML/截图备份、Stitch -> Figma 落地方式和结果、Figma 链接。
...
- 使用 Stitch 时，先记录 Project、screenId、来源 Lovart 图、HTML/截图备份、Figma 落地方式和结果；最终必须映射到 Figma Frame。
...
| 备用 Lovart 稿 |  |
| Stitch screen / HTML |  |
| Stitch -> Figma | AI 自动 / 用户手动 Copy/Paste / 不适用 / 阻塞 |
