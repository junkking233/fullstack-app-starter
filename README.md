...
│   ├── 原型生图提示词.md       # Lovart 生图提示词（按需生成）
│   ├── 页面设计.md             # Lovart 设计稿拆解（按需生成）
│   └── 需求文档.md            # 需求文档
└── README.md                 # 项目说明入口
```
...
| `docs/原型生图提示词.md` | 基于需求文档生成的 Lovart APP UI 原型生图提示词，按需生成。 |
| `docs/页面设计.md` | 基于 Lovart 原型图、PSD、PNG 拆解出的页面设计说明，按需生成。 |
| `docs/需求文档.md` | 需求文档。 |
