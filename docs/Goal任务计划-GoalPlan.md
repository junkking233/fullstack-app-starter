...
- [ ] 2. Lovart Prompt：生成 `design/lovart/原型生图提示词-LovartPrompt.md`，同步 `index.html` Lovart 翻页复制区，调用 `lovart-skill` 生成 P0/P1 单页原型图，并记录 Project/thread/输出文件。
- [ ] 3. Stitch 重建与 Figma 设计稿拆解：调用 Stitch 重建 UI screen，并已由用户手动 Copy/Paste 到 Figma 形成真实 Frame；生成 `docs/设计还原文档-UIDesign.md`。
