...
本文件跟踪当前项目阶段、任务复选框、缺陷和阻塞。AI 每完成一项任务，都必须同步勾选本文件，并让根目录 `index.html` 展示同一进度摘要；阶段 2 完成后，还必须同步 Lovart 提示词复制区。
...
- [ ] 2. Lovart Prompt：生成 `design/lovart/原型生图提示词-LovartPrompt.md`，只覆盖 P0/P1 单页开发稿，并同步 `index.html` Lovart 复制区。
