...
| 2. Lovart Prompt | 基于 PRD 生成受控的单页原型提示词，并同步到网页复制区 | `design/lovart/原型生图提示词-LovartPrompt.md`、`index.html` |
...
- 第 2 步生成提示词后，必须把每个页面的完整提示词同步到 `index.html` 的 Lovart 提示词复制区，方便直接复制到 Lovart。
...
- `index.html` 展示进度摘要和阶段 2 的 Lovart 提示词复制区，详细任务以 GoalPlan 为准。
